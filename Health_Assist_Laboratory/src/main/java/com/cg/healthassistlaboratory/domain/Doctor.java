...
public class Doctor {
	...
	/**
	 * creating getter for doctorSpecialization to get the doctorSpecialization
	 * details
	 * 
	 * @return
	 */
	...
	/**
	 * creating setter for the doctor specialization to set the parameter value to
	...
	/**
	 * creating getter for doctorPhoneNumber to get the details for
	 * doctorPhoneNumber
	 * 
	 * @return
	 */
	...
	/**
	 * creating setter for doctorPhoneNumber to set the parameter value for
	 * doctorPhoneNumber
	 * 
