...
/**
 * This is a Medical Test class which has fields related to medical test This
...
public class MedicalTest {
	...
	/**
	 * creating a setter for medicalTestName to set the parameter value for
	 * medicalTestName
	 * 
	...
	/**
	 * creating a getter for medicalTestPrice which returns the value for
	 * medicalTestPrice
	 * 
	 * @return
	 */
	...
	/**
	 * creating parameterized constructor for medicalTest which sets the parameters
	 * for respective fields when object is created
	 * 
	 * @param medicalTestId
	 * @param medicalTestName
	 * @param medicalTestPrice
